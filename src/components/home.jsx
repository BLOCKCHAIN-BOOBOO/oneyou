...
const Home = () => {
  ...
  const click = (section) => {
    ...
    // setShowModal(true);
    // setMessage("open");
    let render = showmodalsection(section);
    setRenderer(render);
  };
        ...
        <div className="flex xl:flex-row md:flex-col sm:flex-col flex-col w-full  mt-16">
          ...
          <div className="flex m-1 flex-col self-center justify-center xl:w-4/6 md:w-full sm:w-full w-full">
            ...
            <div className="home-header w-full flex flex-col flex sm:flex md:hidden xl:hidden sm:flex-col md:flex-row xl:flex-row">
              {/* dir="ltr" */}
              <div className="current-plan font-semibold px-5 py-2 m-2">
                View Only{" "}
                <div className="starter ml-2 px-5 py-2">
                  To edit please go to Desktop
                  <img
                    src={downarrow}
                    className="ml-2 float-right flex"
                    height="10"
          ...
          <div className="right-0 m-1 justify-center self-center xl:w-2/6 md:w-5/6 sm:w-full w-full flex hidden sm:hidden md:flex xl:flex">
            <div className="home-profile-edit ">
              ...
              <div className="flex py-2">
                ...
                >
                  <img src={home} className="m-2" height="18" width="18" />
                  Your Details
                </button>
                <button
                ...
                >
                  <img src={file} className="m-2" height="15" width="15" />
                  Templates
                </button>
                <button
             ...
             <div className="bg-gray-100 m-2 w-full flex self-center justify-center py-2"> 
               <button className="publish-site m-1 flex py-2 px-6"> Save & Update </button>
                <button className="reset-btn m-1 flex py-2 px-6"> Reset </button>
                  ...
                  <div
                    className="accordion-bg m-2"
                    onClick={() => click("Education Details")}
                  >
                    <button className="flex justify-between flex-row user-setting-btn">
                      Education Section
                      <i className="fa fa-angle-right user-setting-right-btn self-center float-right flex"></i>{" "}
          ...
          return (
               ...
               <button className="publish-site m-1 flex py-2 px-6"> Save & Update </button>
                <button className="reset-btn m-1 flex py-2 px-6"> Reset </button>
                  ...
                  <div
                    className="accordion-bg m-2"
                    onClick={() => click("Experience Details")}
                  >
                    <button className="flex justify-between flex-row user-setting-btn">
                      Experience Section
                      <i className="fa fa-angle-right user-setting-right-btn self-center float-right flex"></i>{" "}
...
<button className="reset-btn m-1 flex py-2 px-6"> Reset </button>
              ...
              {typeActive === "templates" && (
                <div className="xl:m-5 md:m-5 sm:m-2 m-2 accordion-card mx-auto rounded-xl w-full p-2 h-full">
                  <div
                    className="flex grid grid-cols-1 gap-2 sm:grid sm:grid-cols-2 my-3 sm:gap-2 md:grid md:grid-cols-2 
                md:gap-2 lg:grid lg:grid-cols-2 lg:gap-2 xl:grid xl:grid-cols-2 xl:gap-2"
                  >
                ...
                <div className="xl:m-5 md:m-5 sm:m-2 m-2 accordion-card mx-auto rounded-xl w-full p-2 h-full">
                  ...
                  >
                    <div className="flex flex-col py-4">
                      ...
                      <div className="flex">
                        <span className="domain-text text-sm self-start text-left">
                          Don't Have a Domain? Check Oneyou Domain Plans{" "}
                        </span>
                        <img
                          src={nextbtn}
